        ...
        <section className="relative mb-6 overflow-hidden rounded-3xl bg-gradient-to-br from-[#0d5cab] via-[#1676cc] to-[#29a1e6] px-6 py-8 text-white shadow-xl sm:px-9">
          ...
          <div className="relative flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-blue-100 sm:text-base">{isAllData ? "Viewing policy activity for all employees." : "Track your entries and keep today&apos;s work moving."}</p>
            </div>

...
router.patch("/:department/entries/:id/status", DepartmentDashboardController.updateEntryStatus);
router.get("/:department/entries/:id/history", DepartmentDashboardController.entryHistory);
...
router.get("/:department/followups", DepartmentDashboardController.followups);
router.post("/:department/followups", DepartmentDashboardController.createFollowup);

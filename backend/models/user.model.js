...
class UserModel {
    ...
    static async findById(id) {
        const query = `
            SELECT 
                e.id, e.employee_code, e.name, e.user_type, e.status, e.gender, e.date_of_birth, e.personal_email,
                e.department AS department_id, e.designation AS designation_id,
                e.reporting_manager AS reporting_manager_id,
                e.relationship_manager AS relationship_manager_id,
                e.reporting_branch AS reporting_branch_id,

...
import { ensurePoliciesMotorSchema } from "./models/operations/policy-workspace/policiesMotorSchema.model.js";
...
import setCommRoutes from "./routes/accounts/setcomm.routes.js";
...
app.use(
    "/api/setcomm",
    authMiddleware,
    requireAnyDepartmentAccess("accounts", "operations"),
    setCommRoutes
);
...
app.use((req, res, next) => {
    next(notFound("The requested API endpoint could not be found."));
});

...
import { sendPasswordResetEmail } from "../../services/auth/mail.service.js";
import EmployeeDocumentService from "../../services/auth/employeeDocument.service.js";
import { getFrontendUrl } from "../../config/origins.js";
import { getPortalAccess, isSuperAdmin } from "../../config/departmentAccess.js";
import { getRoleCapabilities } from "../../utils/roleAccess.js";
...
const buildAuthUser = (user) => {
    ...
    return {
        ...
        portal_access: getPortalAccess(user),
        access_role: roleCapabilities.role,
        capabilities: roleCapabilities,
    };
};

const preventAuthCache = (res) => {
...
class AuthController {
    ...
    static async login(req, res, next) {
        try {
            ...
            if (String(user.status || "").toLowerCase() !== "active") {
                return errorResponse(res, "This employee account is inactive. Contact HR.", null, 403);
            }
    ...
    static async forgotPassword(req, res, next) {
        try {
            ...
            if (!frontendUrl) {
                const error = new Error("APP_URL must be configured");
                error.statusCode = 500;
                throw error;
            }

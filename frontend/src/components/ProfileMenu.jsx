      ...
      {open && (
        <div className="absolute right-0 z-50 mt-3 w-60 rounded-2xl border border-gray-200 bg-white p-3 shadow-xl">
          <div className="mb-2 border-b border-gray-100 px-2 py-2">
            ...
            <p className="mt-0.5 text-xs font-semibold text-gray-500">{user?.employee_code || "Employee"} · {roleLabel(user)}</p>
            <p className="mt-0.5 truncate text-[11px] font-medium text-gray-400">{user?.department || "Department not assigned"}</p>
          </div>

...
const getSearchSelectStyles = (hasError = false, minHeight = 44) => ({
  control: (provided, state) => ({
    ...provided,
    minHeight,
    borderColor: hasError ? "#f87171" : state.isFocused ? "#1E88E5" : "#cbd5e1",
    ...
    "&:hover": { borderColor: hasError ? "#f87171" : state.isFocused ? "#1E88E5" : "#94a3b8" },
  }),
  valueContainer: (provided) => ({ ...provided, minWidth: 0, padding: "2px 14px" }),
  input: (provided) => ({ ...provided, color: "#334155", margin: 0, minWidth: 0 }),

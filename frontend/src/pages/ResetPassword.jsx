        ...
        {validating ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <label className="relative block pt-2">
              <span className="pointer-events-none absolute left-3 top-0 z-10 bg-white px-1 text-[9px] font-bold uppercase leading-none tracking-widest text-slate-600">New Password</span>
            ...
            <label className="relative block pt-2">
              <span className="pointer-events-none absolute left-3 top-0 z-10 bg-white px-1 text-[9px] font-bold uppercase leading-none tracking-widest text-slate-600">Confirm Password</span>
              <input
                type={showPassword ? "text" : "password"}

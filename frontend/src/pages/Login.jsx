        ...
        <div className="w-full max-w-md bg-white/80 backdrop-blur-xl rounded-[2rem] shadow-2xl border border-white/40 p-6 sm:p-8 transition-all duration-500 hover:shadow-3xl z-10">
          ...
          <form onSubmit={handleLogin} className="space-y-4 sm:space-y-5">
            ...
            <div className="relative pt-2">
              <label htmlFor="login-identifier" className="pointer-events-none absolute left-3 top-0 z-10 bg-white px-1 text-[9px] font-bold uppercase leading-none tracking-widest text-gray-600">
            ...
            {/* Password Field */}
            <div className="relative pt-2">
              <label htmlFor="login-password" className="pointer-events-none absolute left-3 top-0 z-10 bg-white px-1 text-[9px] font-bold uppercase leading-none tracking-widest text-gray-600">
                Password
              </label>
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors group-focus-within:text-blue-500">

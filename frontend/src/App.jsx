...
import OperationsDepartmentApp from "./departments/operations/DepartmentApp";
      ...
      <Route element={<PrivateRoute />}>
        <Route element={<PortalShell />}>
          ...
          <Route element={<DepartmentRoute portal={PORTALS.ACCOUNTS} />}>
            <Route path="accounts/*" element={<AccountsDepartmentApp />} />
          </Route>

          <Route element={<DepartmentRoute portal={PORTALS.HUMAN_RESOURCES} />}>
            <Route path="human-resources/*" element={<HumanResourcesDepartmentApp />} />
          </Route>

...
import { ArrowRight, CalendarDays, Clock3, Files, History, RefreshCw, TrendingDown, TrendingUp } from "lucide-react";
...
export default function Dashboard() {
  ...
  return (
    <main className="flex-1 bg-slate-50 px-4 py-7 sm:px-6 lg:px-12 lg:py-10">

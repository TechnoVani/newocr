...
function SBIPolicyCard({ item }) {
  ...
  const mergedVehicle = {
    ...
    commercialVehicleType: sanitizeValue(extractedVehicle.commercialVehicleType !== "-" ? extractedVehicle.commercialVehicleType : vehicle?.commercialVehicleType),
    subType: sanitizeValue(extractedVehicle.subType !== "-" ? extractedVehicle.subType : vehicle?.subType),
  };

...
export default function AddReference({ portalLabel = "Operations", reportTitle = "Operations Reference Report" }) {
      ...
      >
          <div className="grid grid-cols-1 gap-4 sm:col-span-full sm:grid-cols-2 md:grid-cols-6">
            {DROPDOWN_STEPS.map((step, idx) => {
              ...
              return (
                <div key={step.name} className="relative min-w-0 pt-2">
                  <label className="pointer-events-none absolute left-3 top-0 z-10 max-w-[calc(100%-1.5rem)] truncate bg-white px-1 text-[9px] font-bold uppercase leading-none tracking-wider text-slate-500">
                    {step.label}
                  </label>
            ...
            <div className="relative min-w-0 pt-2">
              <label className="pointer-events-none absolute left-3 top-0 z-10 bg-white px-1 text-[9px] font-bold uppercase leading-none tracking-wider text-slate-500">
                Reference Name
              </label>
              <input
                type="text"

...
import GeneraliCentralPolicyCard from "./GeneraliCentralPolicyCard";
...
const companyMap = [
  ...
  },
  {
    keywords: [
      ...
      "generali central insurance company",
      "generali central insurance co",
      "future generali india insurance",
      "future generali",
    ],
    component: GeneraliCentralPolicyCard,
  },
  {
    keywords: ["go digit insurance", "go digit general insurance", "digit insurance", "go digit"],
...
function PolicyCardWrapper({ item, motorProps = {} }) {
  ...
  // The selected parser component is intentionally resolved from PDF/provider content.
